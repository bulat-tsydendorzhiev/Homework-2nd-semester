...
public class StackCalculatorTests
{
    ...
    {
        double arrayStackAnswer = StackCalculator.CalculateExpression(expression, new ArrayStack());
    ...
    {
        double listStackAnswer = StackCalculator.CalculateExpression(expression, new ListStack());
    ...
    {
        Assert.Throws<ArgumentNullException>(() => StackCalculator.CalculateExpression(null, new ArrayStack()));
        Assert.Throws<ArgumentNullException>(() => StackCalculator.CalculateExpression(null, new ListStack()));
    }
    ...
    {
        Assert.Throws<ArgumentException>(() => StackCalculator.CalculateExpression(expression, new ArrayStack()));
        Assert.Throws<ArgumentException>(() => StackCalculator.CalculateExpression(expression, new ListStack()));
    }
    ...
    {
        Assert.Throws<DivideByZeroException>(() => StackCalculator.CalculateExpression(expression, new ListStack()));
        Assert.Throws<DivideByZeroException>(() => StackCalculator.CalculateExpression(expression, new ArrayStack()));
    }
